/*! peerjs.min.js build:0.3.9, production. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */
(function (e) {
    function n() {
    ...
    function f(e, t) {
        ...
        this._dc = e, h.debug = t, this._outgoing = {}, this._incoming = {}, this._received = {}, this._window = 1e3, this._mtu = 500, this._interval = 0, this._count = 0, this._queue = [], this._setupDC()
    }

    function p(e, t) {
        if (!(this instanceof p)) return new p(e, t);
        u.call(this), e && e.constructor == Object ? (t = e, e = undefined) : e && (e = e.toString()), t = h.extend({
            debug: 0,
            host: h.CLOUD_HOST,
            port: h.CLOUD_PORT,
            key: "peerjs",
        ...
        }, t), this.options = t, t.host === "/" && (t.host = window.location.hostname), t.path[0] !== "/" && (t.path = "/" + t.path), t.path[t.path.length - 1] !== "/" && (t.path += "/"), t.secure === undefined && t.host !== h.CLOUD_HOST && (t.secure = h.isSecure()), t.logFunction && h.setLogFunction(t.logFunction), h.setLogLevel(t.debug);
    ...
    function v(e, t, n) {
        ...
        u.call(this), this.options = h.extend({}, n), this.open = !1, this.type = "media", this.peer = e, this.provider = t, this.metadata = this.options.metadata, this.localStream = this.options._stream, this.id = this.options.connectionId || v._idPrefix + h.randomToken(), this.localStream && m.startConnection(this, {
    ...
    function g(e, t, n, r, i) {
        ...
        var s = e ? "https://" : "http://",
            o = e ? "wss://" : "ws://";
        this._httpUrl = s + t + ":" + n + r + i, this._wsUrl = o + t + ":" + n + r + "peerjs?key=" + i
    }
    var t = {};
    ...
    u.prototype.addListener = function (e, t, n, r) {
        ...
        return this.emit("newListener", e, typeof t.listener == "function" ? t.listener : t), this._events[e] ? a(this._events[e]) ? this._events[e].push(t) : this._events[e] = [this._events[e], t] : this._events[e] = t, this
        ...
        }, h.debug && (this._outgoing[this._count].timer = new Date), this._sendWindowedChunks(this._count), this._count += 1
    }, f.prototype._setupInterval = function () {
        var e = this;
        this._timeout = setInterval(function () {
            var t = e._queue.shift();
            if (t._multiple)
                for (var n = 0, r = t.length; n < r; n += 1) e._intervalSend(t[n]);
            else e._intervalSend(t)
        }, this._interval)
    }, f.prototype._intervalSend = function (e) {
        var t = this;
        e = h.pack(e), h.blobToBinaryString(e, function (e) {
            t._dc.send(e)
        ...
        case "ack":
            ...
            if (!!i) {
                var o = e[2];
                i.ack = Math.max(o, i.ack), i.ack >= i.chunks.length ? (h.log("Time: ", new Date - i.timer), delete this._outgoing[t]) : this._processAcks()
            }
            break;
        case "chunk":
            i = n;
            ...
            var a = e[2],
                f = e[3];
            i.chunks[a] = new Uint8Array(f), a === i.ack[2] && this._calculateNextAck(t), this._ack(t);
            break;
        default:
            this._handleSend(e)
        }
        ...
        for (var s = t.ack; s < i; s += 1)
            if (!n[s].sent || s === t.ack) n[s].sent = !0, r.push(["chunk", e, s, n[s].payload]);
        ...
        return e
    }, f.prototype.onmessage = function (e) {}, e.Reliable = f, e.RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription, e.RTCPeerConnection = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection, e.RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate;
    var l = {
            iceServers: [{
        ...
        h = {
            ...
            setLogLevel: function (e) {
                var t = parseInt(e, 10);
                isNaN(parseInt(e, 10)) ? h.logLevel = e ? 3 : 0 : h.logLevel = t, h.log = h.warn = h.error = h.noop, h.logLevel > 0 && (h.error = h._printWith("ERROR")), h.logLevel > 1 && (h.warn = h._printWith("WARNING")), h.logLevel > 2 && (h.log = h._print)
            },
            setLogFunction: function (e) {
                e.constructor !== Function ? h.warn("The log function you passed in is not a function. Defaulting to regular logs.") : h._print = e
            },
    ...
    e.util = h, h.inherits(p, u), p.prototype._initializeServerConnection = function () {
        var e = this;
        this.socket = new g(this.options.secure, this.options.host, this.options.port, this.options.path, this.options.key), this.socket.on("message", function (t) {
            e._handleMessage(t)
        ...
        var t = this,
            ...
            i = r + this.options.host + ":" + this.options.port + this.options.path + this.options.key + "/id",
            s = "?ts=" + (new Date).getTime() + "" + Math.random();
        i += s, n.open("get", i, !0), n.onerror = function (e) {
            h.error("Error retrieving ID", e);
            var n = "";
            t.options.path === "/" && t.options.host !== h.CLOUD_HOST && (n = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."), t._abort("server-error", "Could not get an ID from the server." + n)
            ...
            if (s) h.warn("Offer received for existing Connection ID:", i);
                ...
                if (n.type === "media") {
                    ...
                    s = new d(r, this, {
                        ...
                        reliable: n.reliable
                    }), this._addConnection(r, s), this.emit("connection", s)
                }
        ...
        default:
            ...
            s && s.pc ? s.handleMessage(e) : f ? this._storeMessage(f, e) : h.warn("You received an unrecognized message:", e)
        }
        ...
        if (this.disconnected) {
            h.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."), this.emitError("disconnected", "Cannot connect to new Peer after disconnecting from server.");
            return
        }
        if (!t) {
            h.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");
            return
        }
        n = n || {}, n._stream = t;
        ...
        h.error("Aborting!"), this._lastServerId ? this.disconnect() : this.destroy(), this.emitError(e, t)
    }, p.prototype.emitError = function (e, t) {
        h.error("Error:", t), typeof t == "string" && (t = new Error(t)), t.type = e, this.emit("error", t)
        ...
        if (this.disconnected && !this.destroyed) h.log("Attempting reconnection to server with ID " + this._lastServerId), this.disconnected = !1, this._initializeServerConnection(), this._initialize(this._lastServerId);
        else {
        ...
        var t = this,
            n = new XMLHttpRequest,
            r = this.options.secure ? "https://" : "http://",
            i = r + this.options.host + ":" + this.options.port + this.options.path + this.options.key + "/peers",
            s = "?ts=" + (new Date).getTime() + "" + Math.random();
        i += s, n.open("get", i, !0), n.onerror = function (n) {
            t._abort("server-error", "Could not get peers from the server."), e([])
        }, n.onreadystatechange = function () {
            if (n.readyState !== 4) return;
            if (n.status === 401) {
                var r = "";
                throw t.options.host !== h.CLOUD_HOST ? r = "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : r = "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.", new Error("It doesn't look like you have permission to list peers IDs. " + r)
            }
            n.status !== 200 ? e([]) : e(JSON.parse(n.responseText))
        }, n.send(null)
    }, e.Peer = p, h.inherits(d, u), d._idPrefix = "dc_", d.prototype.initialize = function (e) {
        this._dc = this.dataChannel = e, this._configureDataChannel()
    }, d.prototype._configureDataChannel = function () {
        var e = this;
        h.supports.sctp && (this._dc.binaryType = "arraybuffer"), this._dc.onopen = function () {
            h.log("Data channel connection success"), e.open = !0, e.emit("open")
        }, !h.supports.sctp && this.reliable && (this._reliable = new f(this._dc, h.debug)), this._reliable ? this._reliable.onmessage = function (t) {
            e.emit("data", t)
        } : this._dc.onmessage = function (t) {
        ...
        } else this.serialization === "json" && (n = JSON.parse(n)); if (n.__peerData) {
            var s = n.__peerData,
                o = this._chunkedData[s] || {
                    data: [],
                    count: 0,
                    total: n.total
                };
            o.data[n.n] = n.data, o.count += 1, o.total === o.count && (delete this._chunkedData[s], n = new Blob(o.data), this._handleDataMessage({
                data: n
        ...
        if (this.serialization === "json") this._bufferedSend(JSON.stringify(e));
            ...
            h.supports.sctp ? h.supports.binaryBlob ? this._bufferedSend(r) : h.blobToArrayBuffer(r, function (e) {
                n._bufferedSend(e)
        ...
        if (this._buffering || !this._trySend(e)) this._buffer.push(e), this.bufferSize = this._buffer.length
    ...
    }, h.inherits(v, u), v._idPrefix = "mc_", v.prototype.addStream = function (e) {
        ...
        if (this.localStream) {
            h.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
            return
        }
        this.options._payload._stream = e, this.localStream = e, m.startConnection(this, this.options._payload);
    ...
    m._idPrefix = "pc_", m.startConnection = function (e, t) {
        var n = m._getPeerConnection(e, t);
        e.type === "media" && t._stream && n.addStream(t._stream), e.pc = e.peerConnection = n;
        if (t.originator) {
            if (e.type === "data") {
                var r = {};
                h.supports.sctp || (r = {
        ...
        m.pcs[e.type] || h.error(e.type + " is not a valid connection type. Maybe you overrode the `type` property somewhere."), m.pcs[e.type][e.peer] || (m.pcs[e.type][e.peer] = {});
        ...
        var r = e.peer,
            i = e.id,
            s = e.provider;
        h.log("Listening for ICE candidates."), t.onicecandidate = function (t) {
            t.candidate && (h.log("Received ICE candidates for:", e.peer), s.socket.send({
                type: "CANDIDATE",
                payload: {
            ...
            case "disconnected":
            case "failed":
                h.log("iceConnectionState is disconnected, closing connections to " + r), e.close();
                break;
            case "completed":
                t.onicecandidate = h.noop
            }
        }, t.onicechange = t.oniceconnectionstatechange, h.log("Listening for `negotiationneeded`"), t.onnegotiationneeded = function () {
            h.log("`negotiationneeded` triggered"), t.signalingState == "stable" ? m._makeOffer(e) : h.log("onnegotiationneeded triggered when not stable. Is another connection being established?")
        }, h.log("Listening for data channel"), t.ondatachannel = function (e) {
            h.log("Received data channel");
            var t = e.channel,
                n = s.getConnection(r, i);
            n.initialize(t)
        }, h.log("Listening for remote stream"), t.onaddstream = function (e) {
        ...
        var t = e.pc;
        !!t && (t.readyState !== "closed" || t.signalingState !== "closed") && (t.close(), e.pc = null)
    }, m._makeOffer = function (e) {
        var t = e.pc;
        t.createOffer(function (n) {
            h.log("Created offer."), !h.supports.sctp && e.type === "data" && e.reliable && (n.sdp = f.higherBandwidthSDP(n.sdp)), t.setLocalDescription(n, function () {
                h.log("Set localDescription: offer", "for:", e.peer), e.provider.socket.send({
                    type: "OFFER",
                    payload: {
                        sdp: n,
                        type: e.type,
                ...
                e.provider.emitError("webrtc", t), h.log("Failed to setLocalDescription, ", t)
            })
        }, function (t) {
        ...
        var t = e.pc;
        t.createAnswer(function (n) {
            h.log("Created answer."), !h.supports.sctp && e.type === "data" && e.reliable && (n.sdp = f.higherBandwidthSDP(n.sdp)), t.setLocalDescription(n, function () {
                h.log("Set localDescription: answer", "for:", e.peer), e.provider.socket.send({
                    type: "ANSWER",
                    payload: {
                        sdp: n,
                        type: e.type,
        ...
        var r = t.pc;
        h.log("Setting remote description", n), r.setRemoteDescription(n, function () {
            h.log("Set remoteDescription:", e, "for:", t.peer), e === "OFFER" && m._makeAnswer(t)
        }, function (e) {
            t.provider.emitError("webrtc", e), h.log("Failed to setRemoteDescription, ", e)
        })
    }, m.handleCandidate = function (e, t) {
        var n = t.candidate,
            r = t.sdpMLineIndex;
        e.pc.addIceCandidate(new RTCIceCandidate({
            sdpMLineIndex: r,
            candidate: n
        })), h.log("Added ICE candidate for:", e.peer)
    }, h.inherits(g, u), g.prototype.start = function (e, t) {
        ...
        this._socket = new WebSocket(this._wsUrl), this._socket.onmessage = function (e) {
            try {
            ...
            t._timeout && (clearTimeout(t._timeout), setTimeout(function () {
                t._http.abort(), t._http = null
            }, 5e3)), t._sendQueuedMessages(), h.log("Socket open")
        }
        ...
        if (s) {
            e._index += 1;
            if (e._index === t.length) e._buffer || (e._buffer = []), e._buffer.push(e._index - 1);
            else {
                try {
                    s = JSON.parse(s)
                } catch (i) {
